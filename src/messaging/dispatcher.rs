...
pub fn func_connect(caller: Caller, input: Vec<WasmValue>) -> Result<Vec<WasmValue>, HostFuncError> {
    ...
    if socket_path.is_empty() {
        ...
        unsafe {
            ...
            //ext_func_result = shim_listener::connect_unix_socket("a".as_bytes().to_vec(), socket_path).unwrap();
        }
        //UNTIL HERE
    }
...
fn find_container_path_parallel(path: &str, function_name: &str) -> String {
